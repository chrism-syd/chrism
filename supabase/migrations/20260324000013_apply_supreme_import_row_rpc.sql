...
begin
  ...
  if p_import_mode = 'update_existing' and p_existing_person_id is not null then
...
comment on function public.apply_supreme_import_row(
  ...
  text,
  text
) is 'Apply one Supreme import row transactionally across people, organization_memberships, person_kofc_profiles, and organization_kofc_profiles.';
