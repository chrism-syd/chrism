...
export function UsCcicCartProvider({ children }: { children: ReactNode }) {
...
export function useUsCcicCart() {
  const context = useContext(CartContext)
  if (!context) throw new Error('useUsCcicCart must be used inside UsCcicCartProvider')
  return context
}
