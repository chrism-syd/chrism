              ...
              return (
                <article className="ccic-featured-case-card" key={item.id}>
                  ...
                  <div className="ccic-featured-case-copy">
                    ...
                    <p className="ccic-featured-case-price">{formatChristmasCardMoney(item.priceCents)} per case <span className="ccic-unit-price">({formatChristmasCardMoney(Math.round(item.priceCents / item.boxesPerCase))} per box)</span></p>
